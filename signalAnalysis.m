...
hypothesis_values_freq= zeros(4,length_freqbands);
p_values_freq= zeros(4,length_freqbands);
means=zeros(2,length_freqbands,4);
std_deviations=zeros(2,length_freqbands,4);
